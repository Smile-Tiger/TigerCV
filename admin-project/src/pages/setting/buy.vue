    ...
    <FormDrawer ref="formDrawerRef" title="配置" @submit="submit">
      <el-form v-if="drawerType == 'alipay'" :model="form" label-width="80px">
        ...
        <el-form-item label="ali_public_key">
          <el-input v-model="form.alipay.ali_public_key" placeholder="ali_public_key" style="width:90%;" type="textarea"
            rows="4"></el-input>
        </el-form-item>
...
<script setup>
import { getSysconfig, setSysconfig, uploadAction } from '@/apis/sysconfig';
...
const getData = async () => {
  ...
  form.value.password_encrypt = res.password_encrypt.split(',')
}
